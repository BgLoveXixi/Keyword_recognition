...
def main(_):
  ...
  time_shift_samples = int((FLAGS.time_shift_ms * FLAGS.sample_rate) / 1000) #100
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--data_dir',
      type=str,
      default='/home/xiezihao/data/speech_dataset/',
      help="""\
  ...
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='/home/xiezihao/data/retrain_logs',
  ...
  parser.add_argument(
      '--train_dir',
      type=str,
      default='/home/xiezihao/data/speech_commands_train',
